...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='./tm/',
    ...
    file_path = 'C:/Users/Admin/PycharmProjects/pythonProject2/SuperPointPretrainedNetwork/veintest2/'
    ...
    for i in range(1, 637):
        ...
        for j in range(1, 7):
            ...
            np.savetxt(file_path + "pts%d_%d.txt" % (i, j), pts)
            np.savetxt(file_path + "desc%d_%d.txt" % (i, j), desc)
